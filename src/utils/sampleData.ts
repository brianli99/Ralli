...
export const sampleCourts: Omit<Court, 'id' | 'created_at' | 'updated_at'>[] = [
  ...
  },
  {
    ...
    description: 'Large open fields perfect for soccer, volleyball, and pickup games.',
    latitude: 37.8021,
    longitude: -122.4662,
  ...
  {
    name: 'Marina Green Field',
    description: 'Open grass field popular for soccer and casual volleyball.',
    latitude: 37.8040,
    longitude: -122.4430,
    sports: ['soccer', 'volleyball'],
    address: 'Marina Blvd, San Francisco, CA',
    amenities: ['Open space', 'Flat terrain', 'Bay views', 'Parking nearby']
  },
  {
...
('Crissy Field Sports Fields', 'Large open fields perfect for soccer, volleyball, and pickup games.', 37.8021, -122.4662, ARRAY['soccer', 'volleyball', 'basketball'], 'Crissy Field, San Francisco, CA', ARRAY['Open fields', 'Bay views', 'Parking', 'Restrooms', 'Picnic areas']),
...
('Marina Green Field', 'Open grass field popular for soccer and casual volleyball.', 37.8040, -122.4430, ARRAY['soccer', 'volleyball'], 'Marina Blvd, San Francisco, CA', ARRAY['Open space', 'Flat terrain', 'Bay views', 'Parking nearby']),
